...
ELSE(WIN32)
  ...
  IF(DCMTK_WITH_TIFF)
    ...
    message(WARNING "TIFF: ${TIFF_INCLUDE_DIR}")
    message(WARNING "JPEG: ${JPEG_INCLUDE_DIR}")
  ENDIF(DCMTK_WITH_TIFF)
  ...
  IF(DCMTK_WITH_PNG)
    ...
    ENDIF(NOT PNG_FOUND)
        message(WARNING "PNG:"${PNG_INCLUDE_DIR}")
  ENDIF(DCMTK_WITH_PNG)
  ...
  IF(DCMTK_WITH_OPENSSL)
    ...
    ENDIF(NOT OPENSSL_FOUND)
            message(WARNING "OpenSSL:${OPENSSL_INCLUDE_DIR}")
  ENDIF(DCMTK_WITH_OPENSSL)
